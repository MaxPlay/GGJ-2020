...
public class Customer : MonoBehaviour {
    ...
    private GameObject duckWaitBar;
    private DuckWaitBarManager duckWaitBarManager;
    ...
    private void Start () {
        ...
        //Edit Nico
        duckWaitBarManager = FindObjectOfType<DuckWaitBarManager> ();
        GetWaitBar ();
    }
    ...
    private void UpdateWaitBar (float timeLeft) {
        ...
        duckWaitBar.GetComponent<DuckWaitBar> ().SetPositionToDuck (transform);

        duckWaitBar.GetComponent<DuckWaitBar> ().SetWaitBar (timeLeft);

    }

    private void DisableWaitBar () {

        duckWaitBar.GetComponent<DuckWaitBar> ().DisableBars ();
